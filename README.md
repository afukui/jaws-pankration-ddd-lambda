...
```bash
vaccination_reservation_demo$ sam local start-api
vaccination_reservation_demo$ curl http://localhost:3000/
```
...
```bash
vaccination_reservation_demo$ sam logs -n HelloWorldFunction --stack-name vaccination_reservation_demo --tail
```
